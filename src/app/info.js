...
export const COMMON_QUESTIONS = [
    {
        ...
        response: "A partir do dia 24/08/2023, às 08:00h, as inscrições estarão abertas para todos interessados. As inscrições serão feitas utilizando um sistema da FUNARBE, em um link externo. Basta clicar nas opções de link descritas como 'Ingressos'."
    }
];
