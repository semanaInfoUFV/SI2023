        ...
        <div className="my-10 text-white">
          ...
          <div className='bg-[#38124A] flex-col-reverse md:flex-row flex justify-evenly p-8 md:p-16'>
            ...
            <div className='md:w-1/3 flex flex-col items-center justify-center' id='maratona'>
              ...
              <Button target="_blank" href={Info.EVENT_MARATONA_SUBSCRIPTION_URL} variant="contained" disableElevation className='mb-10 md:mb-0 bt-tickets-invert hover:bg-[#38124A] rounded-3xl py-4 px-7 bg-[#E4E7E5] hover:text-[#F6F6F6] font-bold border-2 border-solid hover:border-[#E4E7E5] text-[#38124A] mt-10'>
                <Stack spacing={1} direction="row">
          ...
          <div className="bg-[#38124A] -mx-10 md:-mx-20 py-10 overflow-hidden">
            <div className="flex space-x-8 animate-infinite-slider infinite w-full">
              {Info.EVENT_SPONSORS.map((data, index) => (
                <Link className='w-40 h-40 md:w-72 md:h-72' key={index} target="_blank" href={data.url}><img className='slide flex w-40 h-40 md:w-72 md:h-72 items-center justify-center' src={data.image}></img></Link>
              ))}
              {Info.EVENT_SPONSORS.map((data, index) => (
                <Link className='w-40 h-40 md:w-72 md:h-72' key={Info.EVENT_SPONSORS.length + index} target="_blank" href={data.url}><img className='slide flex w-40 md:w-72 items-center justify-center' src={data.image}></img></Link>
              ))}
            </div>
          </div>
